...
```text
โจทย์ให้ตรวจว่าเลขกับตัวอักษรตรงกันไหม และได้รางวัลอะไร
input : 2 บรรทัด บรรทัดแรกคือ รางวัลใหญ่ บรรทัด 2 คือ ที่ซื้อมา
output : จำนวนเงินรางวัล
constraints : ตัวอักรษร 1 ตัว และเลข 5 หลัก
```
