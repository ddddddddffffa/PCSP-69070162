...
```text
input คือ คำอะไรก็ได้
output คือ จำนวนสระที่อยู่ในคำ
constraints คือ ต้องนับแค่สระ
```
...
```text
step1 : รับค่าแล้วทำให้เป็นตัวเล็กทั้งหมดเพราะโจทย์บอกไม่สนพิมพ์เล็กใหญ่
step 2 : สร้างตัวแปรไว้เก็บสระ
step 3 : ตั้ง count ให้เป็น 0
step 4 : ตั้ง for loop
step 5 : ใช้ count[sara.index(char)] += 1 เพื่อนับจำนวนสระ
step 6 : สร้างตัวแปรใหม่ขึ้นมาเพื่อทำให้ตัวที่ count เป็น 0 ไม่ออกมาเป็น output
step 7 : print คำตอบ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เพราะลองทดสอบแล้วโค้ดสามารถใช้ได้
```
...
```text
เพราะจะได้ทดสอบว่าโค้ดจะเอามาแต่สระไหม
```
...
```text
เพราะจะได้ทดสอบว่าโค้ดสามารถรับได้ทั้งตัวเล็กใหญ่
```
...
```text
เพราะจะได้ทดสอบว่าโค้ดสามารถใช้งานได้
```
