...
```text
โจทย์ให้รับจำนวน n เข้ามาเพื่อวนลูปนับ + -
input : รับจำนวนเต็ม n
output : พิมพ์คำตอบที่ได้หลังคำณวน
```
...
```text
1 : รับ int(n)
2 : วนลูป n ครั้งเพื่อรับ + -
3 : คำณวนว่ามี + , - กี่ตัว แล้วค่าที่ได้คือเท้าไหร่
4 : print
```
