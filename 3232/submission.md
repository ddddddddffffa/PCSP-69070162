...
```text
โจทย์ให้หาจำนวนครั้งการกระโดดน้อยที่สุดเพื่อให้ระยะรวม โดยครั้งแรกกระโดดได้ X เมตร และครั้งถัดๆ ไประยะจะลดลงทีละ 2 เมตร ถ้าระยะกระโดดลดลงจนเป็น 0 หรือติดลบแล้วยังไม่ถึง Y ให้ตอบ -1
Input:
จำนวนเต็มสองจำนวน X และ Y
Output:
จำนวนครั้งที่กระโดด หรือ -1 ถ้าระยะรวมไปไม่ถึง Y
Constraints:กบจะหยุดกระโดดเมื่อระยะกระโดด < 0
```
...
```text
1 : อ่านค่า X Y
2 : กำหนดค่าเริ่มต้นของ ระยะทาง และ จำนวนการกระโดด ให้ = 0 และ ระยะการกระโดดในปัจจุบัน = x
3 : ให้ while loop เพื่อ บวก ระยะกระโดด ไปใน ระยะทาง และ เพิ่ม จำนวนกระโดด 1
4 : ตรวจเงื่อนไขตอนออกจาก loop ถ้าระยะมากกว่า Y ให้พิมพ์คำตอบ ถ้าน้อยกว่า Y ให้ตอบ -1
```
