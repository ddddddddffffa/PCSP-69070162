...
```text
โจทย์ให้หา ฤดู ตามวันและเดือนที่กำหนด และ ถ้าเป็นวันที่ 21 ขึ้นไปของเดือนที่หาร 3 ลงตัว จะเปลี่ยนฤดูเป็นฤดูถัดไป
```
...
```text
step1 : รับ input เดือน และ วัน
step 2 : เก็บค่า 21-31 ไว้ใน a
step 3 : ใช้ if  หาว่า ถ้าเป็นเดือนที่หาร 3 ลงตัว และ วันที่อยู่ใน a ให้ print ฤดูถัดไปแทน
step 4 :ใช้ elif เพื่อหาว่าถ้าเป็นเดือนและวันที่ปกติ ให้ print ฤดูปัจจุบัน
...
```text
ใช้เหมือนแผนแรก ใช้ if เพื่อดูว่าตรงเงื่อนไขที่ว่า ถ้าเป็นเดือนที่หาร 3 ลงตัว และ วันที่เป็นวันที่21-31 ให้ print ฤดูถัดไป แต่ถ้าไม่ใช่ ให้ printฤดูในปัจจุบัน
```
...
```text
เพราะถ้าเดือนที่หาร 3 ลงตัว และ วันที่เป็นวันที่21-31 จะต้อง print ฤดูต่อไป
```
...
```text
เพราะถ้าไม่ใช่เดือนที่หาร 3 ลงตัว และ วันที่เป็นวันที่21-31 จะต้อง print ฤดูปัจจุบัน
```
