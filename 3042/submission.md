...
```text
โจทย์ให้รับค่ามาเป็นจำนวณเต็มบวก และ ตั้งแต่ N ถึง 0 ทีเลขไหนบ้างที่หาร 10 ลงตัว
input เลขที่ต้องการ
output เลขทั้งหมดที่หาร10ได้ลงตัว
constraits ไม่มี
```
...
```text
step 1 : รับค่าเข้ามา
step 2 :  ใช้ for ลูปสร้างเงื่อนไข --> for A in range(N - (N % 10), -1, -10) โดยที่ N - (N % 10) มีไว้ปัดเศษที่เกินมา , -1 มีไว้ทำให้เงื่อนไขนี้หยุดทำงานก่อนถึง -1 และ -10 คือให้นับลดลงทีละ 10
step 3 : print คำตอบ
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก รับ input มา ใช้ for loop ในการหาว่ามีเลขอะไรบ้างที่หาร 10 ลงตัว และ print คำตอบ
```
...
```text
เพื่อ test ว่า code ใช้ได้จริง
```
...
```text
เพื่อ test ว่า code ใช้ได้จริง และสามารถปัดเศษได้
```
