...
```text
โจทย์ให้เขียน code คำนวณหาอุณหภูมิเมื่อเปลี่ยนหน่วย
input : อุณหภูมิ , หน่วยแรก , หน่วยที่จะเปลี่ยน
output : อุณหภูมิหลังเปลี่ยนหน่วย
constraits ต้องรับค่ามาเป็น float เพราะอาจมีทศนิยม
```
...
```text
step 1 : รับค่าเข้ามา
step 2 : ใช้ if เพื่อดูว่าหน่วยแรกที่รับเข้ามาตรงกับเงื่อนไขไหน
step 3 : เปลี่ยนให้เป็นหน่วย celsius ทั้งหมด
step 4 : ใช้ if เพื่อตรวจว่าหน่วยที่ต้องการเปลี่ยนตรงกับเงื่อนไขไหน
step 5: เอาคำตอบที่ได้จาก step 4 มาคำนวณโดยใช้สูตรที่โจทย์ให้มาเพื่อหาอุณหภูมิหลังเปลี่ยนหน่วย
step 6 : print อุณหภูมิหลังเปลี่ยนหน่อย โดยมีทศนิยม 2 ตำแหน่ง ด้วยก้ารใช้ f"{:.2f}"
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ใช้ if else เพื่อตรวจสอบว่าตรงกับเงื่อนไขไหน เพื่อนแปลงเป็นหน่วยที่ต้องการ
...
```text
เพื่อทดสอบว่าสามารถเปลี่ยน celsius ไปเป็น farenheit
```
...
```text
เพื่อทดสอบว่าสามารถเปลี่ยน farenheit ไปเป็น rankine
```
...
```text
เพื่อทดสอบว่าสามารถเปลี่ยน kelvin ไปเป็น celsius
```
