...
```text
โจทย์ให้รับ str 5 บรรทัดแล้วเอามาใส่กรอบ
input : string 5 บรรทัด
output : string 5 บรรทัด แบบมีกรอบ * ล้อมรอบ
...
```text
ต้องรู้ว่าคำไหนยาวสุดเพื่อทำให้กรอบพอดีกับคำ
1 : รับค่า
2 : วนลูปแล้วใช้ max(len()) หาคำที่ยาวที่สุด 
3 : print กรอบบน
4 : print คำข้างใน โดยการลูป เพื่อเว้นช่องว่างระหว่างคำ กับ *
5 : print กรอบล่าง
