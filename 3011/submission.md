...
```text
โจทย์ให้ผสมแม่สี 2 สีเข้าด้วยกันแล้วให้ได้ผลตามที่โจทย์ต้องการ
input คือ แม่สี 2 สีเอามาผสมกัน
output คือ สีที่ได้จากการผสมแม่สี และ ถ้าผสมสีอื่นที่ไม่ใช่แม่สีจะ error
constraints คือ ต้องพิจารณาว่าสีที่ผสมกันเป็นแม่สีไหม
```
...
```text
step 1 : อ่านสีที่ใส่เข้ามา
step 2 : ใช้ if else ในการแยกว่าถ้าเป็นแม่สีให้ print สีที่ได้
step 3 : ถ้าไม่ใช่แม่สีให้ print error
step 4 : print สีที่ได้ หรือ error
```
...
```text
เหมือนแผนแรกก็คือ ใช้ if else ในการ แยกว่ารับสีไหนเข้ามาบ้าง และ print คำตอบออกมา
```
...
```text
เพราะจะได้ทดสอบว่า code ใช้งานได้จริง
```
...
```text
เพราะจะได้ทดสอบว่าถ้ามีสีที่ไม่ใช่แม่สีโผล่มาจะ error
```
...
```text
เพราะจะได้ทดสอบว่าไม่สามารถผสมสีในแม่สี กับ สีที่ไม่ใช่แม่สี
```
