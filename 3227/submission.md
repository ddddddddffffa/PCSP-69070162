...
```text
โจทย์ให้รับชื่อย่อของไพ่ เปลี่ยนเป็นชื่อเต็ม
input : ชื่อไพ่ และ ดอก
...
```text
1 : รับ input ชื่อย่อไพ่
2 : สร้าง dict 2 อันเก็บ key เป็นตัวย่อ และ value เป็นชื่อเต็ม
3 : ใช้ .get เพื่อดึงค่าใน dict มา
4 : print คำตอบ
```
...
```text
เพื่อตรวจว่า code สามารถใช้ได้
```
