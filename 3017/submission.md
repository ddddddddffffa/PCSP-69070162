...
```text
 โจทย์กำหนดให้ค่าบริการคือ 10% ของราคาอาหาร แต่ว่าค่าบริการจะเท่ากับ 50 < x < 1000 ละคิดค่า VAT อีก 7% จาก ราคาอาหาร + ค่าบริการ แล้วให้หาว่าราคาทั้งหมดคือเท่าไหร่
input คือ ค่าอาหารของลูกค้าแบบยังไม่บวกเพิ่ม
output คือ ค่าอาหารของลูกค้าหลัง บวกค่าบริการและVAT
constraints คือ input สามารถเป็นทศนิยมได้จึงต้องใช้ float
```
...
```text
step1 : รับค่าอาหารเข้ามา
step 2 : คำนวณหาค่าอาหารก่อน VAT
step 3 : ถ้าค่าอาหารมากว่า 10000 ค่าอาหาร + ค่าบริหารจะ = money + 1000
step4 : ถ้าค่าอาหารมากกว่า 499 ค่าอาหาร + ค่าบริการจะ = money + money*0.1(0.1 คือ 10% ของราคาอาหาร)
step 5 : ถ้าค่าอาหารน้อยกว่า 499 ค่าอาหาร + ค่าบริการจะ = money + 50
step6 : นำค่าอาหารที่บวกกับค่าบริการในกรณีที่ได้มาคิดรวมกัย VAT
step7 : ใช้ vat = total + total*0.07(0.07 มากจากvat 7%)
step8 : print ผลลัพท์ ผมใช้ f string เพื่อที่จะใช้ :.2f ทำให้มีทศนิยมแค่ 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายเหมือนแผนแรก ผมใช้ if else ในการแยกว่าราคาไหนค่าบริการเท่าไหร่ เพื่อนำไปคิดรวมกับ vat และ print คำตอบออกมา
```
...
```text
เพราะจะได้ตรวจได้ว่า ค่าบริการขั้นต่ำต้องเป็น50
```
...
```text
เพราะจะได้ตรวจได้ว่า ค่าบริการมากสุดได้แค่ 1000
```
...
```text
เพราะจะได้ตรวจได้ว่า ค่าบริการ 10% ที่ไม่น้อยกว่า 50 และ มากกว่า 1000 ใช้ได้จริง
```
