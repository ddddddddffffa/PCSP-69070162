...
```text
รับค่า R G B มา 2 บรรทัดแล้ว หา ค่าเฉลี่ย ของ R G และ B
input : จำนวนเต็ม n >= 0 2 บรรทัด บรรทัดละ 3 ตัว
output : ค่าที่ได้หลังหาค่าเฉลี่ยของแต่ละตัว
constrains : คั่นด้วยช่องว่าง โดยไม่ต้องมีข้อความอื่นปะปน
```
...
```text
1 : รับค่า input 3 ตัว 2 บรรทัด
2 : คำณวนหาค่าเฉลี่ยของแต่ละสี
3 : print คำตอบที่ได้
```
...
```text
เพื่อตรวจว่า code สามารถใช้งานได้
```
